...
monstre_t * monstre_creer(monstre_data_t * data, int xCase, int yCase) {
	...
	monstre->data = data;
	monstre->x = xCase * TAILLE_CASES;
	monstre->y = yCase * TAILLE_CASES;
	monstre->hitBox = (SDL_Rect) {monstre->x, monstre->y, TAILLE_CASES, TAILLE_CASES};
...
int monstre_getXCase(monstre_t * monstre) { return monstre->x / TAILLE_CASES; }
int monstre_getYCase(monstre_t * monstre) { return monstre->y / TAILLE_CASES; }
